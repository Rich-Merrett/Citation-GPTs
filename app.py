...
UI_CHAT_TITLE = os.environ.get("UI_CHAT_TITLE") or "Citation Code Assist"
UI_CHAT_DESCRIPTION = os.environ.get("UI_CHAT_DESCRIPTION") or "This chatbot is configured to help you with your code."
